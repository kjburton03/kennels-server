...
from views import update_animal, get_animals_by_location_id, get_animals_by_status
from views import get_all_locations, get_single_location
from views import create_location, delete_location
from views import get_all_customers, get_single_customer, get_customers_by_email
from views import create_customer, delete_customer
from views import get_all_employees, get_single_employee, get_employees_by_location_id
from views import create_employee, delete_employee
